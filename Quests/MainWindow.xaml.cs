...
namespace QuestClient
{
    ...
    public partial class MainWindow
    {
        ...
        private readonly VolumeSampleProvider _mp3Volume;
        ...
        public MainWindow()
        {
            ...
            if (File.Exists(@"Media\background.mp3"))
            {
                ...
                {
                    Volume = float.Parse(ConfigurationManager.AppSettings["BackgroundMuiscVolume"], CultureInfo.InvariantCulture)
                };
